/*
  Template Name: سوروچی - Fashion eCommerce HTML Template
...
var swiper = new Swiper(".product__swiper--column3", {
  ...
  navigation: {
    nextEl: ".new__product--sidebar .swiper-button-prev",
    prevEl: ".new__product--sidebar .swiper-button-next",
  },
});
...
document.querySelectorAll("[data-countdown]").forEach(function (elem) {
  ...
  const countDownInterval = setInterval(function () {
    ...
    elem.innerHTML =
      countDownItem(daysValue, "روز") +
      countDownItem(hoursValue, "ساعت") +
      countDownItem(minutesValue, "دقیقه") +
      countDownItem(secondsValue, "ثانیه");
